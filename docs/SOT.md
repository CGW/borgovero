...
agency-site link harvester ran (202 of 466 portal rows for
Leonardi/House/Romolini/Cortesi now carry their own-site URL in
`url_alt`, tracked as `phase0/data/url_alt.json`); the candidate-pair
...
`self_contradictions.py`'s axis. The harvester's numbers: 202/466
matched, ref route idle everywhere (portal `agency_ref` all NULL),
Romolini partial (33/93) because robots forbids query-param pagination.
