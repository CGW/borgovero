...
**Last updated:** 2026-08-30 (S008 — the dossier session: the
...
which moves 22 tiers and nudges all eight comune bands. **Next: the
§16d eyeball queue — the €149.000 pair, the Via Tiberina 4-way, the
Centogambe 0032 pair — then S009.**)
