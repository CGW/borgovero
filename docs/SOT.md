...
discipline); and **the queued exhibit died honorably** — the
...
which moves 22 tiers and nudges all eight comune bands. Awaiting
Christopher's machine: `apply_S008_typology.py`, `apply_S008_data.sql`,
deploy. **Next: the €149.000 human look, then S009.**)
